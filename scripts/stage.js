...
document.querySelectorAll('[data-rail]').forEach(block=>{
 ...
 track.addEventListener('pointerdown',e=>{
  ...
  drag={id:e.pointerId,x:e.clientX,left:track.scrollLeft};suppressClick=false;
 ...
 track.addEventListener('pointermove',e=>{
  ...
  if(suppressClick){track.classList.add('is-dragging');track.scrollLeft=drag.left-dx;}
 });
 function endDrag(e){
  if(!drag||drag.id!==e.pointerId)return;
